...
| 7 — Case pages + ship | 🟡 In progress | **Six case pages done** (`/case/$slug`, §8.5 depth table, work-index links wired). **A11y/responsive audit + deploy not started** — next up. |
